...
@section('info.powered-by')
    Powered by <a href="http://geocadict.com" target="_blank">Geocadict.com</a> All rights reserved.
@stop
...
@if (strtolower(env('APP_ENV'))=='demo')
    @section('info.buy-now')
        <div class="cm-flex"> <a class="btn btn-block btn-lg btn-success" href="#">B--</a></div>
    @stop
    ...
    <div class="col-xs-12" style="margin-top:10px;z-index:999999">
        <div class="table-responsive mt-1">
            <table style="cursor:pointer;font-size:12px;z-index:999999" class="table table-bordered">
                ...
                <tfoot><tr><th colspan="3"><a class="btn btn-block btn-lg btn-success" href="#">Buy now</a></th></tr></tfoot>
            </table> 
        </div>
    </div>
    ...
    if(window.self !== window.top | window.location !== window.parent.location) { 
        ...
        info.innerHTML = "Demo is not working? browse directly <a target='_blank' href='#'>Lets Go</a>";                   
